          ...
          row.map((cell, colIndex) => {
            ...
            return (
              ...
              className={`
                  ...
                  } sm:w-10 sm:h-10 md:w-[min(5vw,80px)] md:h-[min(5vw,80px)] cursor-pointer flex items-center justify-center transition-all duration-200 border border-border/40 rounded-lg
